	...
	render() {
		return (
			<div className="content">
				<section className="section has-text-centered dark-section">
				...
				<section className="section">
					...
					<div className="columns">
						<div className="column is-6">
							<div className="subtitle">SSO Isso Sso Oold</div>
							<p>
				...
				<section className="section light-section">
					<h4 className="has-text-centered margin-b">ChainTap Already Works</h4>
					<div className="columns">
						<div className="column  is-6">
